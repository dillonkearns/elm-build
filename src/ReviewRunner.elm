            ...
            (\loaded ->
                ...
                , counters =
                    Dict.fromList
                        ...
                        , ( "load_review_project.extend_user_modules_ms", loaded.profile.extendUserModulesMs )
                        , ( "load_review_project.normalize_user_modules_ms", loaded.profile.normalizeUserModulesMs )
                        , ( "load_review_project.extend_resolved_user_modules_ms", loaded.profile.extendResolvedUserModulesMs )
